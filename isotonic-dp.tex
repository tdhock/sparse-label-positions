...
The initialization is $K_1=1,\, N_{1,1}=1,\, T_{1,1}=y_1,\, M_{1,1}=y_1$, which represent $F_1^\leq$.
...
\begin{theorem}
  The recursively computed values $K_n,N_{n,k},T_{n,k},M_{n,k}$ define a function $F_n^\leq$ which is equal to the optimal cost, $C_{n}^\leq$.
\end{theorem}
\begin{proof}
TODO
\end{proof}
